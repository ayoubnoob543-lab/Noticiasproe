...
- `safe_increment_daily_stats()`: Safe counter increment for visits
- `safe_increment_authenticated_visit()`: For authenticated visits
...
- Ensure proper RLS on all tables
...
- Only ayoubnoob543@gmail.com is admin
*/
...
-- Admin check policy for profiles
